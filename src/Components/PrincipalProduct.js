...
const PrincipalProduct = ({
  ...
  return (
    <>
      <section
        className={`PrincipalProduct ${onBlack && "principalProdcut-active"}`}
      >
        ...
        <section>
          <div className="container_img_Principal">
            ...
            {productFive && (
              <img
                className="secondProduct"
                src={fivePrincipalProduct}
                alt="Auricualres Hyperx Orbit S 7.1"
              />
            )}

            <p className="changePrincipalProduct" onClick={onChangeProduct}>
              {" "}
        ...
        <section className="PrincipalProduct_price">
          ...
          <a href="#" className={`${onBlack && "a-is-active"}`}>
